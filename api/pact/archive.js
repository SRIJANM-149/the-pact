// api/pact/archive.js — runs daily at 00:05 UTC via Vercel Cron
import supabase from '../../lib/supabase.js';
import { cors, err } from '../../lib/auth.js';
  ...
  try {
    ...
    for (const pact of activePacts || []) {
      ...
      for (const { user_id } of members || []) {
        // Ensure a record exists (in case person never opened app)
        ...
        // Archive any existing unarchived record
    ...
    console.log(`[archive] ${yesterday}: ${archived} records processed`);
